    ...
    <>
      <div className="bg-danger">
        <div className="container d-lg-flex justify-content-center align-items-center">
          <h1 className="text-light me-1 create-team">Create a Team</h1>
          <img className="trainers" src={trainers} alt="trainers" />
        </div>
      </div>
            ...
            <div className="card-body">
              ...
              {searchQuery && (
                <p className="text-capitalize">
                  <span className="fw-bold">Pokémon to be added:</span>{" "}
                  {filteredName.name}
                </p>
              )}
            </div>
